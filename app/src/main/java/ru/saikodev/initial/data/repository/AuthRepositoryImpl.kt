...
class AuthRepositoryImpl @Inject constructor(
    ...
    override suspend fun terminateSession(sessionId: String): Result<Unit> = try {
        // The API doesn't have a specific terminate endpoint in the current interface,
        // but we can call it via raw request if needed. For now, return not implemented.
